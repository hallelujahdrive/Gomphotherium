public void print_account (Valastodon.Account account) {
	...
	account.note, account.url, account.avatar,
	account.avatar_static, account.header, account.header_static);
}

public void print_status (Valastodon.Status status) {
	...
	stdout.printf ("\n");
	print_attachment (media_attachment);
	});
	...
	stdout.printf ("\n");
	print_application (status.application);
	} else {
	stdout.printf ("null\n");
	}
...
public void print_attachment (Valastodon.Attachment attachment) {
...
public void print_mention (Valastodon.Mention mention) {
...
public void print_tag (Valastodon.Tag tag) {
...
public void print_application (Valastodon.Application application) {
...
public void print_relationship (Valastodon.Relationship relationship) {
...
public void print_instance (Valastodon.Instance instance) {
...
public void print_notification (Valastodon.Notification notification) {
	...
	print_account (notification.account);
	stdout.printf ("\nstatus : ");
...
public void print_report (Valastodon.Report report) {
...
public void print_results (Valastodon.Results results) {
...
public void print_context (Valastodon.Context context) {
...
public void print_card (Valastodon.Card card) {
