...
namespace Valastodon {
	...
	public class Relationship {
		...
		private bool _domain_blocking; // Whether the user is currently blocking the accounts's domain 	
		...
		internal Relationship (Json.Object json_obj) {
			...
			json_obj.foreach_member ((obj, mem, node) => {
				...
				switch (mem) {
					...
					break;
					case "domain_blocking" : _domain_blocking = node.get_boolean ();
					break;
				}
